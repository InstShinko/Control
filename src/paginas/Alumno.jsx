...
function Alumno() {
  ...
  const materias = [
    ...
    { value: "Programación-Software de Escritorio Shinko", label: "Programación-Software de Escritorio Shinko" },
    { value: "Programación-Fundamentos de Páginas web Shinko", label: "Programación-Fundamentos de Páginas web Shinko" },
    ...
    { value: "Diseño-Revelado Fotográfico Shinko", label: "Diseño-Revelado Fotográfico Shinko" },
    { value: "Diseño-Composición Digital Shinko", label: "Diseño-Composición Digital Shinko" },
    { value: "Diseño-Fundamentos y Estructura Editorial Shinko", label: "Diseño-Fundamentos y Estructura Editorial Shinko" },
    { value: "Diseño-Producción de audio Shinko", label: "Diseño-Producción de audio Shinko" },
    { value: "Diseño-Edición de Video Shinko", label: "Diseño-Edición de Video Shinko" },
    { value: "Diseño-Efectos Visuales Shinko", label: "Diseño-Efectos Visuales Shinko" },
